...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("FatCoins"));
    case mBTC: return QString(QObject::tr("Milli-FatCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-FatCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
