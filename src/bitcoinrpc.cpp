...
{
    return GetBoolArg("-testnet", false) ? 19029 : 9029;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop FatCoin server (and possibly override the detachdb config value).");
